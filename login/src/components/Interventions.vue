                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <router-link :to="platform"> <a href="#" class="nav-link ">
                                    <div class="sb-nav-link-icon"> <font-awesome-icon icon="fa-solid fa-credit-card" /></div>
                                    Paiement 
                                </a></router-link>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                        ...
                                        Authentication
                                        <div class="sb-sidenav-collapse-arrow"> <font-awesome-icon
                                                icon=" fas fa-angle-down" /></div>
                                    </a>
...
Admin                    </div>
            ...
            <div id="layoutSidenav_content">
                <ol>
                    <li>Faculté de Médecin et de Pharmacie</li>
                    <li>Faculté des Sciences et Techniques</li>
                    <li>Ecole supérieur Roi Fahd de Traduction</li>
                    <li>Ecole supérieur Nationale des Sciences Appliquées</li>
                    <li>Ecole supérieur Roi Fahd de Traduction</li>
                </ol>
            </div>
        </div>
