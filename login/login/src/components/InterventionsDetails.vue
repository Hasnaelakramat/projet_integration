        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    ...
                    <button class="btn btn-primary" id="btnNavbarSearch" type="button"> <font-awesome-icon
                            icon=" fas fa-search" />
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li> <router-link :to="Profil"> <a href="#" class="dropdown-item ">Profil </a></router-link>
                        </li>
                        <li>
                            <hr class="dropdown-divider" />
                        </li>
                        <li> <router-link :to="home"> <a href="#" class="dropdown-item ">Logout </a></router-link> </li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <router-link :to="Tables"> <a href="#" class="nav-link ">
                            ...
                            <router-link :to="AddAdmin"> <a href="#" class="nav-link ">
                                    <div class="sb-nav-link-icon"> <font-awesome-icon icon="fa-solid fa-user-plus" /></div>
                                    Ajouter un Admin
                                </a></router-link>


                            <router-link :to="Paiement"> <a href="#" class="nav-link ">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"> <router-link :to="platform"><a href="#">Dashboard</a>  </router-link></li>
                            <li class="breadcrumb-item active">Détails des Interventions</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                Vous trouvez ici les informations sur l'université abdelmalek essaadi !
                                
                        </div>
                    </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <font-awesome-icon icon="fa-solid fa-building-columns" /> UAE :                            </div>
                            <div class="card-body">
                                <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <tr>
                                            ...
                                            <th>Validation de l'université</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                            <td>Faculté de Médecine et de Pharmacie</td>
                                            <td>Tanger</td>
                                            <td>(+212)539393744</td>
                                            <td>(+212)539393743</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td>Ecole Supérieure Roi Fahd de Traduction</td>
                                            <td>Tanger</td>
                                            <td> (+212)539942813</td>
                                            <td>(+212)539940835</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td>Ecole Nationale des Sciences Appliquées</td>
                                            <td>Tanger</td>
                                            <td>(+212)539393744</td>
                                            <td>(+212)539393743</td>
                                            <td></td>
