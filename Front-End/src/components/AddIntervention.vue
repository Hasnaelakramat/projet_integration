                                                                ...
                                                                <div class="row ">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="form-floating">
                                                                            ...
                                                                            <label for="inputFaxe"
                                                                                style="font-weight: bold;">semestre :
                                                                            </label><br><br>
                                                                            <input class="form-control"
                                                                                style="height: 50px;" id="inputFaxe"
                                                                                type="text" autocomplete="off"
                                                                                v-model="semestre" required />
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="form-floating">
                                                                            ...
                                                                            <input class="form-control"
                                                                                ...
                                                                                autocomplete="off" v-model="date_fin"
                                                                                required />
...
export default {
    ...
    methods: {
        AjouteIntervention() {
            ...
            axios.post('http://localhost:8000/api/add_intervention', InterventionData, {
                headers: {
